...
function App() {
  ...
  const faqs = [
    {
      question: "What's The Golf Season?",
      answer:
        "All Round. Our Golf Season ranges from winter to summer, anytime is Golf Season",
    },
    {
      question: "Are Caddies Available?",
      answer: "Yes. Caddies are available to Rent For ZAR20",
    },
    {
      question: "Is There A Pitching/Chipping area?",
      answer: "Yes. Both a Pitching and Chipping area are available",
    },
    {
      question: "What is the Dress Code?",
      answer: "Appropriate Golf Attire. Anything you'd wear at the Open",
    },
    {
      question: "Is it Beginner Friendly?",
      answer: "Yes. Practice and Instructors are available.",
    },
    {
      question: "Is Food Available on the Premises?",
      answer: "Yes. A Bar and a Halfway House are available",
    },
    {
    ...
    {
      question: "Are Memberships Available?",
      answer: "Yes. We offer competitive annual membership fees.",
    },
    {
      question: "What is The Price For a Golf Game?",
      answer: "ZAR40 For Affliated members. And ZAR70 for Visitors",
    },
  ];
        ...
        <div className="container" id="cnt">
          {loading ? (
            <div className="loading-screen">
              <div>
                <img src={golfBall} alt="spinning-golf-ball" />
                <p>Loading...</p>
              </div>
            </div>
          ) : (
            ...
            <div className="header-title">
              ...
              <div className="subline" id="subline">
                <p className="subline-text">
                  ...
                  meet exceptional facilities and{" "}
                  <span className="italic"> impeccable service.</span>
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="page">
        <section className="about" id="about">
          <p className="about-text" ref={about.ref}>
            Piet Retief Country Club was founded in
            <span className="italic"> 1957</span> and since then been a
            cornerstone to <span className="italic">leisure</span> activities to
            the small community of Piet Retief. It has a 9 hole golf course
            (which can be played as 18), <span className="italic">squash</span>{" "}
            and <span className="italic">tennis courts</span>, a{" "}
            <span className="italic">swimming pool</span>, gym and a bowls
            section with a clubhouse and bar. The club is situated on the N2 in
            the south-east corner of <span className="italic">Mpumalanga</span>,
            about 30km north of KwaZulu-Natal and 30km west of Swaziland.
          </p>
        </section>
        ...
        <section
          className="territory"
          id="ter"
          ref={territoryRef.ref}
          style={{ backgroundImage: `url(${territoryImg})` }}
        >
          <div className="tt-header">
            <h1>Our Territory </h1>
            <p>
              9 Holes, 35 par ={" "}
              {territoryRef.inView ? <CountUp end={2833} duration={5} /> : 0}{" "}
              meters of Pure Fun
            </p>
          </div>
        </section>
        <section className="contact" id="cont">
          <div className="contact-text">
            <div>
              <h1>
                {" "}
                <span className="italic">Fancy A Game</span> ?
              </h1>
              <h2>
                Get in touch at{" "}
                <span className="italic">{`(+27) 17 826 2625`}</span>
              </h2>
              <h1>
                {" "}
              ...
              <h2>
                ...
                {`-27.01215 `} <span className="italic"> Lng:</span> {`30.7983`}
              </h2>
              <a href="https://maps.app.goo.gl/sYMX78bSnmYg5qWB7">
                1F De Wet St Piet Retief
              </a>
            </div>
          </div>
        ...
        <HelmetProvider>
          <section className="FAQ">
            <Helmet>
              <title>
                Frequently Asked Questions - Piet Retief Country Club
              </title>
              <meta
                name="description"
                content="Find answers to frequently asked questions about our golf course, including season details, availability of caddies, dress code, and more."
              />
          ...
          <div className="plans">
            <div className="prices-cnt">
              ...
              <p>
                ...
                Including additional perks such as free access to the
                pitching/chipping area, discounted lessons with instructors, and
                priority booking for tee times.
              </p>
            </div>
            <div className="prices-cnt">
              <h1>
                <span className="italic">Lessons and Practice</span>
              </h1>
              <p>
                Lesson package with instructors based on instructor's experience
                and lesson duration. nominal fee for access to the
                pitching/chipping area for non-members, included as a Standard
                and Premium membership benefit.
              </p>
            </div>
            <div className="prices-cnt">
              <h1>
            ...
            <div className="prices-cnt">
              <h1>
                <span className="italic">Events and Tournaments</span>
              </h1>
              <p>
                We host regular tournaments and events, entry fees applicable
                that cover day costs Event packages for corporate or private
                events, including catering and use of facilities.
              </p>
            </div>
          </div>
        </section>
        ...
        <footer>
          <div className="footer-cnt">
            ...
            <div className="stats">
              ...
              <ul>
                <li>
                  Length <span className="italic">2833 meters</span>
                </li>
                <li>
                  Holes <span className="italic">9</span>
                </li>
                <li>
                  Par <span className="italic">35</span>
                </li>
                <li>
                  Type <span className="italic">Parklands</span>
                </li>
                <li>
                  Year Built <span className="italic">1957</span>
                </li>
              </ul>
            </div>
            <div className="stats">
          ...
          <div className="legal">
            <p className="copy-right">
              &copy; {new Date().getFullYear()} Piet Retief Golf Club. All
            ...
            <a
              ...
              href="https://www.facebook.com/GOLFPietRetief/"
              target="_blank"
              rel="noopener noreferrer"
            >
